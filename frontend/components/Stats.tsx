const stats = [
  { value: "2M+", label: "SCANS DAILY", border: true },
  { value: "99.8%", label: "DETECTION RATE", border: true },
  { value: "15ms", label: "LATENCY AVG", border: true },
  { value: "0", label: "FALSE POSITIVES", border: false },
];

export default function Stats() {
  return (
    <section className="flex flex-col w-full bg-[#8bfb25] py-12 px-6 md:py-[80px] md:px-[120px]">
